...
/**
 * Initializes with specified size
...
/**
 * Merges two sorted lists in new sorted list
 * @param list1 Pointer to list1 metadata
 * @param list2 Pointer to lsit2 metadata
 * @return New list, that was merged from list1 and list2
 */
